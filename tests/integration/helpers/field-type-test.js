...
module('Integration | Helper | field-type', function(hooks) {
  setupRenderingTest(hooks);

  test('it returns true for field type text', async function(assert) {
    this.set('fieldType', 'text');
    await render(hbs`{{if (field-type fieldType) 'yes the field type is text' 'no the field type is not text'}}`);
  ...
  test('it returns true for field type email', async function(assert) {
    ...
    await render(hbs`{{if (field-type fieldType) 'yes the field type is email' 'no the field type is not email'}}`);
  ...
  test('it returns true for field type number', async function(assert) {
    ...
    await render(hbs`{{if (field-type fieldType) 'yes the field type is number' 'no the field type is not number'}}`);
  ...
  test('it returns false for field type other than text, email and number', async function(assert) {
    ...
    await render(hbs`{{if (field-type fieldType) 'yes the field type is either text, email or number' 'no the field type is not text, email or number'}}`);
