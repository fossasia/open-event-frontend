...
To interact with the other developers join:
-    [Mailing List on Google Groups](https://groups.google.com/forum/#!forum/open-event)
-    [Chat on Gitter](https://gitter.im/fossasia/open-event-frontend)
