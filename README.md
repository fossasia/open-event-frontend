...
The open-event-frontend **development** branch is provided at [https://openeventfrontend.now.sh/](https://open-event-frontend.now.sh/). Use the API provided by the open event server development branch  hosted at [https://openevent.dokku.fossasia.org](https://open-event.dokku.fossasia.org).
