...
export default ModelBase.extend({
  ...
  paypalSandboxUsername  : attr('string'),
  paypalSandboxPassword  : attr('string'),
  paypalSandboxSignature : attr('string'),
  paypalLiveUsername     : attr('string'),
  paypalLivePassword     : attr('string'),
  paypalLiveSignature    : attr('string'),
